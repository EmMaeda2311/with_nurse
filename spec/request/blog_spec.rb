...
RSpec.describe 'Blogs', type: :request do
  ...
  describe 'ログインユーザーではない' do
    ...
    it 'なんとかPOSTしてみても、投稿されない' do
      expect { post blogs_path, params: { blog: { title: 'test', content: 'error text' } } }.to change {
                                                                                                  tester.blogs.count
                                                                                                }.by(0)
    end
  ...
  describe 'ログインユーザー' do
    ...
    it 'post blog' do
      expect { post blogs_path, params: { blog: { title: 'test', content: 'text', tag_ids: 'tag1,tag2' } } }.to change {
                                                                                                                  tester.blogs.count
                                                                                                                }.by(1)
    end
