...
ActiveRecord::Schema.define(version: 20_210_405_134_946) do
  create_table 'action_text_rich_texts', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                                         force: :cascade do |t|
  ...
  create_table 'blogs', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                        force: :cascade do |t|
    t.text 'content'
  ...
  create_table 'likes', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                        force: :cascade do |t|
  ...
  create_table 'tag_relationships', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                                    force: :cascade do |t|
    t.bigint 'blog_id', null: false
    t.bigint 'tag_id', null: false
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[blog_id tag_id], name: 'index_tag_relationships_on_blog_id_and_tag_id', unique: true
    t.index ['blog_id'], name: 'index_tag_relationships_on_blog_id'
    t.index ['tag_id'], name: 'index_tag_relationships_on_tag_id'
  end

  create_table 'tags', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                       force: :cascade do |t|
    t.string 'name', null: false
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
  ...
  create_table 'user_typings', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                               force: :cascade do |t|
  ...
  create_table 'words', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                        force: :cascade do |t|
